...
Revision ID: 9ad52466369a
Revises:
Create Date: 2026-02-16 11:23:46.718094
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("runs", schema=None) as batch_op:
        batch_op.create_index(
            ...
            [sa.literal_column("priority DESC"), sa.literal_column("last_processed_at ASC")],
            unique=False,
